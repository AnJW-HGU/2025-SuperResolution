...
if __name__ == "__main__":
    ...
    torch.save(model_Real_ESRGAN.state_dict(), "models/2_Stage_200_Gan_loss_state_dict.pth")
    torch.save(model_Real_ESRGAN, "models/2_Stage_200_Gan_loss.pth")

    test_model = torch.load("models/2_Stage_200_Gan_loss.pth", weights_only=False).to(device)
    ...
    test_model.load_state_dict(torch.load("models/2_Stage_200_Gan_loss_state_dict.pth"))
    # Get class names
