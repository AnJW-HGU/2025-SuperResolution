...
yml_path = 'external/Real-ESRGAN/experiments/2_Stage_5k_L1_loss/finetune_realesrgan_x4plus_pairdata.yml'
...
pth_path = 'external/Real-ESRGAN/experiments/2_Stage_5k_L1_loss/models/net_g_latest.pth'
