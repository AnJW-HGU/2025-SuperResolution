...
yml_path = 'external/Real-ESRGAN/experiments/E2E_1_all_loss/finetune_realesrgan_x4plus_pairdata.yml'
...
pth_path = 'external/Real-ESRGAN/experiments/E2E_1_all_loss/models/net_g_latest.pth'
